...
3. Logcat filters: `WineAndroidDesktop|WineAndroidHostBridge|defer first register|registerSurface|motion`.
4. PASS examples: defer then real-size register; `motion … ok=true` + visible click; no FATAL/BGRA crash.
