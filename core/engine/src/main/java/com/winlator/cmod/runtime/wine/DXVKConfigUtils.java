...
/**
 * DXVK wrapper env-var configuration (ported verbatim from WinNative
 * {@code feature.settings.DXVKConfigUtils}). Promoted into the runtime wine
 * package because {@link app.amphora.core.engine.XServerWineSessionPreparer}
 * (D9 XSDA extraction) needs it at launch-prep time, not just in the settings
