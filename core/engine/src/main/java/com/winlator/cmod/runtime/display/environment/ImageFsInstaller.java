...
public abstract class ImageFsInstaller {
  ...
  public static void installDriversFromAssets(final android.app.Activity activity) {
    // RFC D8: the single bundled Turnip driver is extracted by P2
    // RootfsInstaller/ContentSource (pre-installed). AdrenotoolsManager no longer
    // exposes extractDriverFromResources; this is a P1 compile no-op placeholder.
  }
