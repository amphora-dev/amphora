...
import com.winlator.cmod.runtime.display.xserver.events.PropertyNotify;
...
public class Window extends XResource {
  ...
  public Window(
      int id, Drawable content, int x, int y, int width, int height, XClient originClient) {
    super(id);
  ...
  public Property modifyProperty(
      int atom, int type, Property.Format format, Property.Mode mode, byte[] data) {
