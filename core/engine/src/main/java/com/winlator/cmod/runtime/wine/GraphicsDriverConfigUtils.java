...
/**
 * Graphics-driver config parser (ported verbatim from WinNative
 * {@code feature.settings.GraphicsDriverConfigUtils}). Promoted into the
 * runtime wine package for {@link app.amphora.core.engine.XServerWineSessionPreparer}
 * (D9). Behaviour is unchanged.
 */
