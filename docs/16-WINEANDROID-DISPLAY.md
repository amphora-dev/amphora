...
| `WineAndroidSessionActivity.kt` | session + 调试 statusView；host composing TextView chip；右上角显式「键盘」chip；`dispatchKeyEvent` → KEYBOARD_EVENT；debug IME unicode / composing extras |
